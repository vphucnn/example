...
const Pools: AddEthereumChainParameter['nativeCurrency'] = {
  name: 'Celo',
  symbol: 'CELO',
  decimals: 18,
}
...
export const TESTNET_CHAINS: ChainConfig = {
  ...
  6868: {
    urls: ['https://rpc.poolsmobility.com/'],
    name: 'Pools Mainnet',
    nativeCurrency: Pools,
    blockExplorerUrls: ['https://scan.poolsmobility.com/'],
  },
}
